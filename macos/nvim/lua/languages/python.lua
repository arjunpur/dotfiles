  ...
  settings = {
    python = {
      analysis = {
        ...
        -- "~" won't work. /home/arjun is a Ubuntu directory path, whereas /Users/arjun is a Mac path
        extraPaths = {"/home/arjun/.local/pipx/venvs/vsketch/lib/python3.9/site-packages/", "/Users/arjun/.local/pipx/venvs/vsketch/lib/python3.9/site-packages"},
      }
    }
  }
}
